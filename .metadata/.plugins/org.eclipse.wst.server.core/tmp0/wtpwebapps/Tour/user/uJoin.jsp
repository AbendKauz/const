         ...
         <form action="/uCate.us" method="post" id="joinFrm" name="joinFrm">
            ...
            <table>
	            <tr>
	            	...
	            	<td>
		            	<input type="text" id="id" name="id" class="join_tag join_id" placeholder="ID : 영문+숫자 포함 6~12" maxlength="12">
		            	<button class="chkId" type="button" id="chkId" name="chkId" onclick="confirmId(this.form)">ID 중복검사</button>
	            	</td>
	            </tr>
	            <tr>
	            </tr>
	            <tr>
	            	...
	            	<td>
		               <input type="password" id="pw" name="pw" class="join_tag" placeholder="비밀번호 : 영문+숫자+특수문자 포함 8~20" maxlength="25">
	            	</td>
	            </tr>
	            <tr>
	            </tr>
	            <tr>
	            	...
	            	<td>
		               <input type="text" id="name" name="name" class="join_tag" placeholder="이름" maxlength="5">
	            	</td>
	            </tr>
	            <tr>
	            </tr>
	            <tr>
	            	...
	            	<td>
		               <input type="text" id="tel" name="tel" class="join_tag" placeholder=" - 없이 전화번호" maxlength="11" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');">
	            	</td>
	            </tr>
	            <tr>
	            </tr>

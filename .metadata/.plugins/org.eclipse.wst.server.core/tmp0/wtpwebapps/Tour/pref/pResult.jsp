...
<body>
	<jsp:include page="../include/header_pref.jsp" />
	<div class="container">

		<form id="frm" name="frm" action="/addPref.pr" method="post">
			...
			<p class="p1">취향 저장 완료</p>
			<div class="box">
				<hr>
				<p class="p2">
					<span class="s1">나만의 취향 코스</span>가 추가되었습니다
				</p>
				<p class="p3">
					<span class="s2">건강해지는 발걸음</span>
				</p>
				<p class="p4">
					<span class="sm3"> <input type="text" id="pref" name="pref"
						readonly>
					</span>
				</p>
				<hr>

...
<body>
	...
	<div class="py-3 text-center">
		...
		<h3>리뷰 수정</h3>
		<p class="lead">사용자가 사진과 함께 리뷰를 수정할 수 있습니다</p>
	</div>
	<div class="col-md-7 col-lg-6 mx-auto">
		<form class="needs-validation" action="/rMod.re" method="post" enctype="multipart/form-data">
			...
			<input type="hidden" id="rbno" name="rbno" value="<%= request.getParameter("rbno") %>">
			...
			<div class="row g-3">
				...
				<input type="hidden" class="form-control" id="images" name="images" value="<%= request.getParameter("file") %>">
			</div>
